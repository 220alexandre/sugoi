...
$url = "https://sugoigame.com.br/Scripts/Geral/ativar_id.php?i=$u_id&cod=$ativacao";

$mail = new Mailer();
$mail_enviado =$mail->send('Sugoi Game - Criação de conta','<div style="margin: 0 auto; background: #F5F5F5; border-radius: 5px; width: 520px; border: 1px dotted #D8D8D8; border-left: 4px solid #CE3233; border-right: 4px solid #CE3233;">
